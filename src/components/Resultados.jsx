        ...
        <div className="cardsCustom">
          <div className="cards-33">
            <img
              ...
              src={graph1}
              alt="Grafico 1"
              onClick={() => window.open(graph1, '_blank')}
            />
            <p>
          ...
          <div className="cards-33">
            <img
              ...
              src={graph2}
              alt="Grafico 2"
              onClick={() => window.open(graph2, '_blank')}
            />
            <img
              className="img-fluid2"
              src={graph3}
              alt="Grafico 3"
              onClick={() => window.open(graph3, '_blank')}
            />
            <p>
          ...
          <div className="cards-33">
            <h6 className="p0 mb-0 align-self-center">
              UFC máxima alcanzada y menor pH detectado
            </h6>
            <img
              className="img-fluid2"
              src={tabla1}
              alt="Tabla de resultados"
              onClick={() => window.open(tabla1, '_blank')}
            />
            <p className='pt-2'>
              <i>L. brevis.</i> UFC maxima alcanzada en medios XOS + Inulina con
              caída de pH de entre 0.8 y 1.3 unidades.{' '}
              <i>L. plantarum y W. cibaria</i> UFC máximos alcanzados en medios
              Inulina, Glucosa y XOS + Inulina . Mayor caída de Ph 5.27{' '}
              <i>L. plantarum</i> y pH 5.75 W. cibaria
            </p>
          </div>
        </div>
      </div>
