    ...
    return (
        <header className="masthead title text-center">
            <div className="container d-flex align-items-center flex-column">
                ...
                <div>
                    <a className="names font-weight-light mb-0" onClick={()=> window.open(carla, "_blank")}>Carla Romano</a>
                </div>
                <div>
                    <a className="names font-weight-light mb-0" onClick={()=> window.open(horacio, "_blank")}>José Horacio Pisa</a>
                </div>
                <div>
                    <a className="names font-weight-light mb-0" onClick={()=> window.open(johan, "_blank")}>Johan Sebastián Hero</a>
                </div>
                <div>
                    <a className="names font-weight-light mb-0" onClick={()=> window.open(alejandra, "_blank")}>María Alejandra Martínez</a>
                </div>
            </div>
        </header>
    )
