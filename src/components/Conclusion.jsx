const Conclusion = () => {
  return (
    <section className=" title page-section portfolio pb-5" id="conclusion">
      ...
      <div className="container pb-5">
        ...
        <span className="text-secondary">
          Los resultados demuestran que la utilización combinada de inulina y
          ...
          sostenible en la elaboración de alimentos funcionales
        </span>
      </div>
    </section>
  )
